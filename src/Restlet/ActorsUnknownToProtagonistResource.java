...
public class ActorsUnknownToProtagonistResource extends Resource {
/*
 * Resource {sessionID}/ActorsUnknownToProtagonist
GET: public String[] getActorsUnknownToProtagonist(String sessionID)
		throws RemoteException, SessionLogoutException;
 */
	private String sessionID;

	public ActorsUnknownToProtagonistResource(Context context, Request request, Response response) {
	...
	public boolean  allowDelete() {
	 ...
	 public Representation represent(Variant variant) throws ResourceException {
		 ...
		 try {
			 	System.out.println("GET ActorsUnknownToProtagonist");
			 	String[] actors  = ServerData.janus.getActorsUnknownToProtagonist(sessionID);
			 	JSONArray jsActors = new JSONArray();
			 	for (String s: actors)
			 		jsActors.put(s);
				result = new JsonRepresentation(jsActors);
